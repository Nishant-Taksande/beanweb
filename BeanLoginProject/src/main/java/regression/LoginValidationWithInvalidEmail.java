...
public class LoginValidationWithInvalidEmail extends TestBase {
	...
	@DataProvider(name = "LoginWithContinue")
	public String[][] getLoginValidationDataFromExcel() throws Exception {

		String str[][] = AppLibrary.readExcel("TestData/LoginValidation.xls", 0);
		return str;
	}
	...
	@Test(dataProvider = "LoginWithContinue")
	public void testLoginValidationWithInvalidEmail(String email, String psd, String validation, String exeIndicator) throws IOException {
