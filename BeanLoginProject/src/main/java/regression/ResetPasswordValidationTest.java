...
public class ResetPasswordValidationTest extends TestBase {
	...
	public void testLoginValidationWithPostiveEmail(String Pass, String CnfPass, String PassValidation,
		...
		if (exeIndicator.equalsIgnoreCase("Yes")) {
			...
			if (!CnfPassValidation.equalsIgnoreCase("")) {
				AppLibrary.findElement(driverw,
						ForgotPasswordPage.cnfPassvalidation.replace("Replace", CnfPassValidation));
			}
